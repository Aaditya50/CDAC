...
public class Main_phone {
    ...
    public static void Display() {
        if (phone.size() != 0) {
            ...
            System.out.println("No contacts in directory, Please add contacts in directory.");
        }
    ...
    public static void Displayfav() {
        if (fav.size() != 0) {
            ...
            System.out.println("No contacts in favourites, Please add contacts in favourites.");
        }
    }
    ...
    public static void Update_Details() {
        if (phone.size() != 0) {
            ...
            System.out.println("No contacts in directory, Please add contacts in directory to update.");
        }
    }
    ...
    public static void MakeCall() {
        if (phone.size() != 0) {
            ...
            System.out.println("No contacts found in directory, Please add contacts in directory to make a call.");
        }
    ...
    public static void DisplayRecent() {
        ...
        if (recentList.size() != 0) {
            ...
            System.out.println("Please make a call to see recent dialed call .");
        }
    }
